...
$(function(){
	$("#busapr").click(function(){
    	$('#resultado').html('');    	
      	...
      	dataString = $("#buscager").serialize();
      	$.ajax({
        	type: "POST",
        	url: "<?php echo base_url();?>index.php/gerar/carreg_ger",
        	data: dataString,        	
        	datatype:'json',
		...
		<div class="col-md-12">
			<div class="panel panel-custom">
				<div class="panel-heading">
			    	<h4><i class="fa fa-search"></i> Filtro p/ Gerar APs</h4>
			    	<h4><span class="label label-warning">Somente adiantamentos <strong>APROVADOS e com o dia FECHADO!</strong></span></h4>
				</div>
				<div class="panel-body">
					<?php 
						$this->load->helper(array('form'));
						echo validation_errors(); 
						$attributes = array('id' => 'buscager', 'class' => 'form-horizontal'); 
						echo form_open('gerar/carreg_ger', $attributes); 
					?>
					<div class="row-fluid">
	...
	<div class="modal fade" id="mRetorno" >
	    ...
	    <div class="modal-content">
	      <div class="modal-header modal-header-custom">
	        ...
	        <h4 class="modal-title">Resultado da Geração de APs</h4>
	      </div>
